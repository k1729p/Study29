...
import static kp.clients.postgresql.PostgreSqlConstants.*;
...
public class PostgreSqlClient {
     ...
     * @param consumer   the result set consumer
     */
    ...
    private static HikariConfig getHikariConfig(String jdbcUrl, String user, String password) {
        ...
        // If the database is down on startup, throw an exception immediately
        // instead of retrying silently in the background.
